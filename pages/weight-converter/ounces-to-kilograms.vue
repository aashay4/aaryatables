...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; OZ to KG<hr>
      <h1 class="w3-text-teal"><b>Ounces to kilograms(KG)</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Ounces:</div>
<div class="col">
...
export default {
  head() {
  return {
    title: 'Ounces(oz) to Kilograms(KG)',
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/ounces-to-kilograms'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        var xx = parseFloat(this.number1)*0.02834952;
        this.answer = this.roundresult(xx);
    },
    roundresult(x) {
      var y = parseFloat(x);
