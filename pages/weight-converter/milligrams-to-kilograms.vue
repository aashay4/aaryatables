...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; Milligrams to KiloGrams<hr>
      <h1 class="w3-text-teal"><b>Milligrams to KiloGrams(g)</b></h1>
      <Adsense
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/milligrams-to-kilograms'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        var xx = parseFloat(this.number1)/1e6;
