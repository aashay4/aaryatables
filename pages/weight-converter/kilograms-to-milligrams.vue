...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; Kilograms to Milligram<hr>
      <h1 class="w3-text-teal"><b>Kilograms to Milligram(kg to MG)</b></h1>
      <Adsense
...
<div class="form-row">
<div id="log" class="col-auto">Enter Kilograms:</div>
<div class="col">
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/kilograms-to-milligrams'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        this.answer = parseFloat(this.number1) * 1000000 + ' Milligram';
    },
    reset(){
      this.number1 = null;
      this.number2 = null;
