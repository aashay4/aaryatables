...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; Pounds to KG<hr>
      <h1 class="w3-text-teal"><b>Pounds to Kilogram(KG)</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Pounds:</div>
<div class="col">
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/pounds-to-kilograms'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        var x = parseFloat(this.number1) * 0.45359237;
        this.answer = this.roundresult(x);
    },
    roundresult(x) {
      var y = parseFloat(x);
