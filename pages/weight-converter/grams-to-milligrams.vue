...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; Grams to Milligrams<hr>
      <h1 class="w3-text-teal"><b>Grams to Milligrams (g to mg)</b></h1>
      <Adsense
...
<div class="form-row">
<div id="log" class="col-auto">Enter Grams:</div>
<div class="col">
        ...
        <h1 class=""><b>Other Weight tools</b></h1>
          ...
          <ul class="w3-ul w3-hoverable w3-white">
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/weight-converter/grams-to-kilograms"> Grams to Kilogram</a></span><br>
            </li>
            <li class="w3-padding-16">
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/grams-to-milligrams'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        this.answer = parseFloat(this.number1)*1000 + ' Milligram';
    },
    reset(){
      this.number1 = null;
      this.number2 = null;
