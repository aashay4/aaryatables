...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; Pounds to OZ<hr>
      <h1 class="w3-text-teal"><b>Pounds to Ounces(OZ)</b></h1>
      <Adsense
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/pounds-to-ounces'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        var x = parseFloat(this.number1) * 16;
