...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    ...
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/weight-converter">Weight</a> &rsaquo; Kilograms to Grams<hr>
      <h1 class="w3-text-teal"><b>Kilograms to Grams(kg to g)</b></h1>
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/kilograms-to-grams'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
        this.answer = parseFloat(this.number1) * 1000 + ' Gram';
    },
    reset(){
      this.number1 = null;
      this.number2 = null;
