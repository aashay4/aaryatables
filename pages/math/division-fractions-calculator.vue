    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-margin w3-white">
        ...
        <div class="w3-container w3-padding">
              <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; Divide fractions<hr>
          <h1 class="w3-text-teal"><b>Division fractions calculator</b></h1>
          <Adsense
...
<div class="">
  ...
  <td id="equitd1346"><input type="number" step="1" v-model="n1" class="form-control" autofocus></td>
  ...
  <tr>
  <td id="tablesqqw"><input type="number" step="1" v-model="d1" class="form-control"></td>
  <td id="tablesqqw44"><input type="number" step="1" v-model="d2" class="form-control"></td>
  </tr>
  </table>
  </div>
        ...
        <h1 class=""><b>Other Number tools</b></h1>
          ...
          <ul class="w3-ul w3-hoverable w3-white">
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/math/adding-fractions-calculator"> Adding fractions calculator</a></span><br>
            </li>
            <li class="w3-padding-16">
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Fractions division calculator.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/division-fractions-calculator'}
    ]
    }
    },
  data(){
...
#equitd1346 { padding-bottom:0px; }
#tablesqqw, #tablesqqw44 { border-top:#666 3px solid; padding-top:1px; }
