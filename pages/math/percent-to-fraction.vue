    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-margin w3-white">
        <div class="w3-container w3-padding">
              <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; Percent to fractions Calculator<hr>
          <h1 class="w3-text-teal"><b>Convert percentage to fraction</b></h1>
          <Adsense
          ...
          <p>Percentage to fraction converter.</p>
<div class="">
...
<div class="form-group">
<label for="y">Answer:</label>
<div class="input-group">
<textarea type="text" v-model="area" class="form-control outtext" readonly></textarea>
</div>
</div>
</form><br>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Convert Percent to fraction',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Percentage to fractions online converter.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/percent-to-fraction'}
    ]
    }
    },
  data(){
...
var x = this.x;
var y = parseFloat(x);
y = this.roundresult(y/100);
if( y<0 )
{
  y = -y;
  sign = '-';
}
var d = this.digits_after_period(y);
var den = Math.round(Math.pow(10,d));
var num = Math.round(y*den);
var g = this.gcd(num,den);
