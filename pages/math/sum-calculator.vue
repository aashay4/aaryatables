...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    ...
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; Sum Calculator<hr>
      <h1 class="w3-text-teal"><b>Sum Calculator</b></h1>
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Sum calculator - Add Numbers' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/sum-calculator'}
    ]
    }
    },
  data(){
