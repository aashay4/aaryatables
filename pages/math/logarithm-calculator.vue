...
<div id="charryberry" class="col-auto mt-2">&times;</div>
<div id="log" class="col-auto">log</div>
...
h3 { font-size:1.4rem; }
h4 { font-size:1.2rem; }
#formnumber1,#calcform2,#calcform3 { background:#a7c9b8; padding:20px; }
...
@media all and (max-width: 800px) {
   ...
   #formnumber1, #calcform3 { padding:10px; }
}
