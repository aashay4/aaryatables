    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-margin w3-white">
        <div class="w3-container w3-padding">
              <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; PPM to ppt Calculator<hr>
          <h1 class="w3-text-teal"><b>Convert PPM to ppt</b></h1>
          <Adsense
          ...
          <p>A simple to use PPM to ppt calculator.</p>
<div class="">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Convert PPM to ppt',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'PPM to ppt conversion tool.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/ppm-to-ppt'}
    ]
    }
    },
  data(){
