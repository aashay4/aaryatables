    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-margin w3-white">
        <div class="w3-container w3-padding">
              <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; Percent to decimal Calculator<hr>
          <h1 class="w3-text-teal"><b>Convert Percentage to numbers</b></h1>
          <Adsense
          ...
          <p>Percentage to numbers conversion tool.</p>
<div class="">
...
<div class="form-group">
<label for="y">Result in decimal:</label>
<div class="input-group">
<input type="text" v-model="y" class="form-control" readonly>
</div>
</div>
<div class="form-group">
<label for="y">Calculation</label>
<div class="input-group">
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Percent to decimal conversion calculator for students and professionals.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/percent-to-decimal'}
    ]
    }
    },
  data(){
