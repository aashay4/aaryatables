    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-margin w3-white">
        ...
        <div class="w3-container w3-padding">
              <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; Subtract fractions<hr>
          <h1 class="w3-text-teal"><b>Subtracting fractions calculator</b></h1>
          <Adsense
...
<div class="">
  ...
  <tr>
  <td id="designtd"><input type="number" step="1" v-model="d1" class="form-control"></td>
  <td id="designtd1"><input type="number" step="1" v-model="d2" class="form-control"></td>
  </tr>
  </table>
  </div>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Subtracting fractions calculator - subtract mixed fractions',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'subtracting fractions calculator.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/subtracting-fractions-calculator'}
    ]
    }
    },
  data(){
...
#designtd { padding-bottom:0px; }
#designtd, #designtd1 { border-top:#666 3px solid; padding-top:1px; }
