    ...
    <div class="w3-col l8 s12">
      ...
      <div class="w3-margin w3-white">
        <div class="w3-container w3-padding">
              <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; ppb to ppm Calculator<hr>
          <h1 class="w3-text-teal"><b>Convert ppb to ppm</b></h1>
          <Adsense
          ...
          <p>A simple to use ppb to ppm calculator.</p>
<div class="">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Convert ppb to ppm',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'ppb to ppm conversion tool.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/ppb-to-ppm'}
    ]
    }
    },
  data(){
