...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; inverse cosine calculator<hr>
      <h1 class="w3-text-teal"><b>inverse cosine calculator for students.</b></h1>
      <Adsense
      ...
      <span class="h1 math">cos<sup class="h4">-1</sup></span>
      <input type="text" v-model="x2" class="form-control col-sm-9 ml-2" required>
      </div>
      <div class="form-group">
      <button type="button" title="Calculate" class="btn btn-success" @click="calculate()"><span>=</span> Calculate</button>
      <button type="button" @click="reset()" title="Reset" class="btn btn-secondary"><span>&times;</span> Reset</button>
      </div>
      <label>Degrees</label>
      <div class="form-row">
      <div class="form-group col">
      <label for="ydeg1">First result</label>
      <input type="text" v-model="ydeg1" class="form-control">
      </div>
      <div class="form-group col">
      <label for="ydeg2">Second result</label>
      <input type="text" v-model="ydeg2" class="form-control">
      </div>
      </div>
      <label>Radians</label>
      <div class="form-row">
      ...
      <input type="text" v-model="yrad1" class="form-control">
      </div>
      <div class="form-group col">
      <label for="yrad2">Second result</label>
      <input type="text" v-model="yrad2" class="form-control">
      </div>
      </div>
      <p>k = ...,-2,-1,0,1,2,...</p>
      </form>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Cosine converter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'inverse cosine calculator' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/cosine-calculator'}
    ]
    }
    },
  data(){
...
this.yrad2 = "";
    ...
    calculate(){
      ...
      var yrad1=Math.acos(x);
      var ydeg1=yrad1*180/Math.PI;
      var yrad2 = -yrad1;
      var ydeg2 = -ydeg1;
      yrad1 = this.roundnum2(yrad1,6);
      ydeg1 = this.roundnum2(ydeg1,6);
      yrad2 = this.roundnum2(yrad2,6);
      ydeg2 = this.roundnum2(ydeg2,6);
      this.ydeg1 = ydeg1+"\u00B0+360k";
      this.yrad1 = yrad1+"rad+2\u03C0k";
      if( x!=1 && x!=-1 ) {
         this.ydeg2 = ydeg2+"\u00B0+360k";
         this.yrad2 = yrad2+"rad+2\u03C0k";
      }
    },
    removeAt(s,i) {
