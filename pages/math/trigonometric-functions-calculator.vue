...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/math">Mathematics</a> &rsaquo; Trigonometric functions calculator<hr>
      <h1 class="w3-text-teal"><b>Trigonometric functions calculator</b></h1>
      <Adsense
      ...
      <form id="inputdesign" autocomplete="off">
      <div class="form-group">
      <div class="input-group">
      <div class="input-group-prepend">
      <select v-model="func" class="form-control form-control-lg math">
      ...
      <option value="5">cot</option>
      <option value="6">arcsin</option>
      <option value="7">arccos</option>
      <option value="8">arctan</option>
      <option value="9">arccsc</option>
      <option value="10">arcsec</option>
      <option value="11">arccot</option>
      </select>
      </div>
      <input type="text" v-model="x" class="form-control form-control-lg ml-2">
      <div class="input-group-append">
      <select v-model="degtype" class="form-control form-control-lg math">
      ...
      <select v-model="degtype3" class="form-control form-control-lg">
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Calculate trigonometric sine, cos, tan, sec, cot, cosec.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/math/trigonometric-functions-calculator'}
    ]
    }
    },
  data(){
