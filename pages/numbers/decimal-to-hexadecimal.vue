...
<div class="form-row">
<div class="col">
<input type="text" id="x" name="x" v-model="number1" class="form-control" placeholder="Enter the Decimal here .... ">
</div>
</div>
...
export default {
  ...
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'A decimal to hexadecimal converter and read how to convert' }
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/numbers/decimal-to-hexadecimal'}
  ]
  }
},
  data(){
