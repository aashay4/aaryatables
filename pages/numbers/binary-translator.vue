...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    ...
    <div class="w3-container w3-padding">
      ...
      <p>Use this binary translator to convert binary to text and other numbering systems. Enter a binary number and click on the answer button for binary translation.</p>
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'A binary translator helps you to convert binary to text with just one click. Just enter the binary number in the box convert it into text.' }
  ],
    link: [
    ...
    bintodecimal(){
     ...
     bintohexadecimal(){
       var binnn = this.number1
         ...
         if (isNaN(binnx)) {
           this.base16 = 'This number cannot be converted into Hex'
         } else {
           this.base16 = binnx
         }
    },
