...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    ...
    <div class="w3-container w3-padding">
      ...
      <h1 class="w3-text-teal"><b>Binary Translator - Binary to English</b></h1>
      <Adsense
      ...
      <p>Use this binary code translator to convert binary to ASCII and other numbering systems. Enter a binary number and click on the answer button for binary translation. For example, enter a binary number <b>01000001</b> in the box and click on the answer button. You will get an A as the binary to word conversion.</p>
...
<h2 class="w3-center"><b>Translate binary code</b></h2>
<p><b>Binary code translator</b> is a tool that helps users to convert binary to all other major numbering systems. Along with all other numbering systems, users can convert binary to English (text) as well.</p>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Binary translator - Free Binary to English Converter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Translate binary code easily with binary translator.' }
  ],
    link: [
...
for (var z = 0; z < binlength; z = z + 8) {
  ...
  this.answer = textresult
    ...
    bintodecimal(){
      ...
      if (isNaN(cc)) {
        this.base10 = 'This number cannot be converted into Decimal'
      } else {
        this.base10 = cc
      }
    },
     ...
     bintooctal(){
       this.xxx = parseInt(this.number1)
         var bintooct = parseInt(this.xxx, 2).toString(8)
         if (isNaN(bintooct)) {
           this.base8 = 'This number cannot be converted into Octal'
         } else {
           this.base8 = bintooct
         }
    },
