<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; W to kwh<hr>
    <h1 class="w3-text-teal"><b>Watts to Kilowatts hour Calculator</b></h1><br>
    <Adsense
...
<div class="form-group">
<label for="x2">Enter time in hours:</label>
<div class="input-group">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Watts(W) to KWH converter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Watts to Kilowatts hour.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/watts-to-kwh'}
    ]
    }
    },
  data(){
