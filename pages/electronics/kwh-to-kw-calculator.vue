<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; Kwh to kw <hr>
    <h1 class="w3-text-teal"><b>Kilowattshour to kw</b></h1>
...
export default {
  head() {
    // sets document title
    return {
      title: 'kilowattshour to kw converter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kwh to kw' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/kwh-to-kw-calculator'}
    ]
    }
    },
  data(){
