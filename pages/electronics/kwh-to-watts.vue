<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; Kwh to watts <hr>
    <h1 class="w3-text-teal"><b>Kilowattshour to watts calculator</b></h1>
    <Adsense
  ...
  <label for="x1">Enter kilowattshours</label>
  ...
  <div class="form-group">
  <label for="x2">Enter hours:</label>
  <div class="input-group">
...
export default {
  head() {
    // sets document title
    return {
      title: 'kilowattshour to watts converter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kwh to watts' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/kwh-to-watts'}
    ]
    }
    },
  data(){
