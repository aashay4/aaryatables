<template lang="html">
  ...
  <div class="form-group">
  <label for="x2">Enter Power</label>
  <div class="input-group">
...
export default {
  head() {
    // sets document title
    return {
      title: 'kilowatts to va',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kw to va' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/kw-to-va'}
    ]
    }
    },
  data(){
