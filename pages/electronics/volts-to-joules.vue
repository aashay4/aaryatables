<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; Volts to joules<hr>
    <h1 class="w3-text-teal"><b>Volts to J</b></h1><br>
    <Adsense
...
export default {
  head() {
    // sets document title
    return {
      title: 'Volts to Joules',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Volts to joules.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/volts-to-joules'}
    ]
    }
    },
  data(){
