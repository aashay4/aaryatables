<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; Volts to Kilowatts<hr>
    <h1 class="w3-text-teal"><b>Volts to Kws</b></h1><br>
    <Adsense
      ...
      <div class="w3-margin w3-white">
        ...
        <h1 class=""><b>Other Electronics tools</b></h1>
          ...
          <ul class="w3-ul w3-hoverable w3-white">
            ...
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/electronics/volts-to-amps"> volt sto ampere</a></span><br>
            </li>
            <li class="w3-padding-16">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Volts to Kilowatts(kws)',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Volts to KWs.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/volts-to-kilowatts'}
    ]
    }
    },
  data(){
