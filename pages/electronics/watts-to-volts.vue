<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; W to V<hr>
    <h1 class="w3-text-teal"><b>Watts(W) to volts Calculator</b></h1><br>
    <Adsense
      ...
      <div class="w3-margin w3-white">
        ...
        <h1 class=""><b>Other Electronics tools</b></h1>
          ...
          <ul class="w3-ul w3-hoverable w3-white">
            ...
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/electronics/watts-to-amps"> watts to Amperes</a></span><br>
            </li>
          </ul>
      </div>
    </div>
...
export default {
  ...
  meta: [
    ...
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/watts-to-volts'}
    ]
    }
    },
  data(){
  ...
  methods: {
    currentchange(){
      ...
      if(this.currenttype === "AC - Single phase"){
        ...
        this.powerfactor = true;
        w/=(this.powerfactorinput*Math.sqrt(3));
        this.kw = w;
      }
