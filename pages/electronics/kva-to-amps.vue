...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kilovolt-amps to ampere (kVA to A) Calculator.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/kva-to-amps'}
    ]
    }
    },
  data(){
