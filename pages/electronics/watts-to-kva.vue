<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; Watts to KiloVolt-ampere<hr>
    <h1 class="w3-text-teal"><b>Watts(W) to KiloVolt-ampere</b></h1><br>
    <Adsense
...
export default {
  head() {
    // sets document title
    return {
      title: 'Watts(W) to Kilovolt-Ampere',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Watts to Kilovolt-ampere.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/watts-to-kva'}
    ]
    }
    },
  data(){
  ...
  methods: {
    currentchange(){
      this.kw = this.number1/this.number2/1000;
  },
    reset(){
