<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; W to Volt-ampere<hr>
    <h1 class="w3-text-teal"><b>Watts(W) to Volt-ampere</b></h1><br>
    <Adsense
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Watts to Volt-ampere.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/watts-to-va'}
    ]
    }
    },
  data(){
