<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; W to J<hr>
    <h1 class="w3-text-teal"><b>Watts(W) to Joules(J) Calculator</b></h1><br>
    <p>Watts to Joules converter.</p>
    <Adsense
...
<div class="form-group">
<label for="x2">Enter time in seconds</label>
<div class="input-group">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Watts(W) to Joules(A) converter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Watts to Joules.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/watts-to-joules'}
    ]
    }
    },
  data(){
