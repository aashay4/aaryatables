<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/electronics">Electronics</a> &rsaquo; Volts to watts<hr>
    <h1 class="w3-text-teal"><b>Volts to W</b></h1><br>
    <Adsense
...
<div class="form-group">
<label for="x2">Enter current:</label>
<div class="input-group">
...
<label for="x2">Enter power factor:</label>
<div class="input-group">
<input type="number" min="0" step="any" v-model="number3" class="form-control" required>
</div>
</div>
<div class="form-group">
      ...
      <div class="w3-margin w3-white">
        ...
        <h1 class=""><b>Other Electronics tools</b></h1>
          ...
          <ul class="w3-ul w3-hoverable w3-white">
            ...
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/electronics/volts-to-amps"> Volts to Amperes</a></span><br>
            </li>
          </ul>
      </div>
    </div>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Volts to watts(W)',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Volts to watts.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/electronics/volts-to-watts'}
    ]
    }
    },
  data(){
  ...
  methods: {
    ...
    currentchange(){
      var kw = this.number1*this.number2;
      if(this.voltagetype === "DC"){
                this.kw = kw;
      }
      else if(this.voltagetype === "AC - Single Phase"){
        kw *=this.number3;
        this.kw = kw;
      }
      else {
        kw*=this.number3*Math.sqrt(3);
        this.kw = kw;
      }
  },
    reset(){
