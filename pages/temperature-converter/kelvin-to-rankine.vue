...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/temperature-converter">Temperature</a> &rsaquo; K to R<hr>
      <h1 class="w3-text-teal"><b>Kelvin to rankine conversion</b></h1>
      <Adsense
...
export default {
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/temperature-converter/kelvin-to-rankine'}
  ]
  }
  },
  data(){
