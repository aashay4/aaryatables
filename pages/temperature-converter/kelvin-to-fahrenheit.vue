...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/temperature-converter">Temperature</a> &rsaquo; K to F<hr>
      <h1 class="w3-text-teal"><b>Kelvin to Fahrenheit conversion</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter kelvin:</div>
<div class="col">
...
export default {
  head() {
  return {
    title: 'Kelvin(K) to Fahrenheit(F)',
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/temperature-converter/kelvin-to-fahrenheit'}
  ]
  }
  },
  data(){
