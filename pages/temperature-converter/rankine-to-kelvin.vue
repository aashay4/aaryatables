...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/temperature-converter">Temperature</a> &rsaquo; R to K<hr>
      <h1 class="w3-text-teal"><b>Rankine to Kelvin(K)</b></h1>
      <Adsense
...
export default {
  head() {
  return {
    title: 'Fahrenheit(F) to kelvin(K)',
  ...
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/temperature-converter/rankine-to-kelvin'}
  ]
  }
  },
  data(){
