...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/voltage-conversion">Voltage</a> &rsaquo; Volts to gigavolts<hr>
      <h1 class="w3-text-teal"><b>Volts to gigavolts</b></h1>
      <Adsense
...
export default {
  head() {
  return {
    title: 'Convert Volts to gigavolts',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Volts to gigavolts conversion tool.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/volts-to-gigavolts'}
  ]
  }
  },
  data(){
