...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; KWH to btu<hr>
      <h1 class="w3-text-teal"><b>Kilowatt hours to btu</b></h1>
      <Adsense
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kwh to btu.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kwh-to-btu'}
    ]
    }
    },
  data(){
