...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Calories to kcal<hr>
      <h1 class="w3-text-teal"><b>Calories to kilocalories(kcal)</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Calories:</div>
<div class="col">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Calories to kilocalories',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Cal to Kcal' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/calories-to-kcal'}
    ]
    }
    },
  data(){
