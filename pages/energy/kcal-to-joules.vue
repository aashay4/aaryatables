...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; kcal to J<hr>
      <h1 class="w3-text-teal"><b>kcal to joules</b></h1>
      <Adsense
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kcal to joules conversion' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kcal-to-joules'}
    ]
    }
    },
  data(){
