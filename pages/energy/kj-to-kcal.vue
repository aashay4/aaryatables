...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Kilojoules to kcal<hr>
      <h1 class="w3-text-teal"><b>Kilojoules to kcal Converter</b></h1>
      <Adsense
...
<button type="button"  class="btn btn-lg btn-outline-secondary">kcal-th</button>
</div>
</div>
</div>
</form>
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kilojoules(Kj) to kcal' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kj-to-kcal'}
    ]
    }
    },
  data(){
  ...
  methods: {
    calculate(){
      var d = this.number1;
      d = parseFloat(d);
        this.answer = (d/4.184).toFixed(10);;
    },
    reset(){
      this.number1 = null;
      this.answer = ''
