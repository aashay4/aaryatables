...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; MEv to ev<hr>
      <h1 class="w3-text-teal"><b>MEv to ev</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Mev:</div>
<div class="col">
...
<button type="button"  class="btn btn-lg btn-outline-secondary"></button>
</div>
</div>
</div>
</form>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Mega-Electron volt(kev) to ev',
  ...
  meta: [
    ...
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/mev-to-ev'}
    ]
    }
    },
  data(){
