...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Kilojoules to BTU<hr>
      <h1 class="w3-text-teal"><b>Kilojoules to BTU Converter</b></h1>
      <Adsense
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kilojoules(kj) to btu' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kj-to-btu'}
    ]
    }
    },
  data(){
  ...
  methods: {
    calculate(){
      var d = this.number1;
      d = parseFloat(d);
        this.answer = (d*0.94781712267).toFixed(10);;
    },
    reset(){
      this.number1 = null;
      this.answer = ''
