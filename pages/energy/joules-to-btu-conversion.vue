...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Joules to British thermal unit<hr>
      <h1 class="w3-text-teal"><b>Joules to BTU</b></h1>
      <Adsense
...
<button type="button"  class="btn btn-lg btn-outline-secondary">BTU</button>
</div>
</div>
</div>
</form>
...
export default {
  head() {
    // sets document title
    return {
      title: 'Joules to British thermal unit(BTU)',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Joules to British thermal unit.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/joules-to-btu.conversion'}
    ]
    }
    },
  data(){
