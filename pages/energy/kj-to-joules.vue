...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; kJ to Joules<hr>
      <h1 class="w3-text-teal"><b>kJ to Joules conversion</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter kilojoules:</div>
<div class="col">
...
<button type="button"  class="btn btn-lg btn-outline-secondary">J</button>
</div>
</div>
</div>
</form>
...
<div class="w3-col l4">
  ...
  <div class="w3-margin">
    <div class="w3-container w3-white">
      <div class="w3-margin w3-white">
          <div class="w3-container w3-padding">
        <h1 class=""><b>Other Energy tools</b></h1>
      </div><hr>
          <ul class="w3-ul w3-hoverable w3-white">
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/energy/joules-to-kcal"> joules to kcal</a></span><br>
            </li>
            <li class="w3-padding-16">
            ...
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/energy/kj-to-joules"> joules to calories</a></span><br>
            </li>
            <li class="w3-padding-16">
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kilojoules(Kj) to joules' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kj-to-joules'}
    ]
    }
    },
  data(){
