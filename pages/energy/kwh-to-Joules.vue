...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; KWH to joules<hr>
      <h1 class="w3-text-teal"><b>Kilowatt hours to joules</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter KWH:</div>
<div class="col">
...
<button type="button"  class="btn btn-lg btn-outline-secondary">KWH</button>
</div>
</div>
</div>
</form>
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kwh to joules.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kwh-to-joules'}
    ]
    }
    },
  data(){
