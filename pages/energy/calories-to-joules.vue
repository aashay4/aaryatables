...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Calories to Joules<hr>
      <h1 class="w3-text-teal"><b>Calories to J</b></h1>
      <Adsense
...
export default {
  ...
  meta: [
    ...
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/calories-to-joules'}
    ]
    }
    },
  data(){
