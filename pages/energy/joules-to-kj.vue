...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; joules to kJ<hr>
      <h1 class="w3-text-teal"><b>joules to Kilojoules Converter</b></h1>
      <Adsense
...
<button type="button"  class="btn btn-lg btn-outline-secondary">kJ</button>
</div>
</div>
</div>
</form>
...
export default {
  ...
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Joules to kilojoules.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/joules-to-kj'}
    ]
    }
    },
  data(){
