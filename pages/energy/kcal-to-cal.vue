...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; kcal to cal<hr>
      <h1 class="w3-text-teal"><b>KiloCalories to cal</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter KiloCalories:</div>
<div class="col">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Kilocalorie to calorie(cal)',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Kilocalorie to calorie' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kcal-to-cal'}
    ]
    }
    },
  data(){
