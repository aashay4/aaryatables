...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; kcal to KJ<hr>
      <h1 class="w3-text-teal"><b>kcal to kilojoules</b></h1>
      <Adsense
...
export default {
  head() {
    // sets document title
    return {
      title: 'kilocalories to kj',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'kcal to kj' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kcal-to-kj'}
    ]
    }
    },
  data(){
