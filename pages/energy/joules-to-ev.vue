...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Joules to electron volt<hr>
      <h1 class="w3-text-teal"><b>Joules to ev</b></h1>
      <Adsense
...
export default {
  head() {
    // sets document title
    return {
      title: 'Joules to electron volt(ev)',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
      { hid: 'description', name: 'description', content: 'Joules to electron volt.' }
  ],
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/joules-to-ev'}
    ]
    }
    },
  data(){
