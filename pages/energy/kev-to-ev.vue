...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; KEv to ev<hr>
      <h1 class="w3-text-teal"><b>KEv to ev</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Kev:</div>
<div class="col">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Kilo-Electron volt(kev) to ev',
  ...
  meta: [
    ...
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/kev-to-ev'}
    ]
    }
    },
  data(){
