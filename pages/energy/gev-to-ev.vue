...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Gev to ev<hr>
      <h1 class="w3-text-teal"><b>Gev to ev</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Gev:</div>
<div class="col">
...
export default {
  head() {
    // sets document title
    return {
      title: 'Giga-Electron volt(kev) to ev',
  ...
  meta: [
    ...
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/gev-to-ev'}
    ]
    }
    },
  data(){
