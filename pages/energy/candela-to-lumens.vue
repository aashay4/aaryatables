<template lang="html">
  ...
  <div class="w3-margin">
      <div class="w3-container w3-padding">
        <a href="/">Home</a> &rsaquo; <a href="/energy">Energy</a> &rsaquo; Candela to lumens <hr>
    <h1 class="w3-text-teal"><b>Candela to lumens</b></h1><br>
    <Adsense
...
export default {
  ...
  meta: [
    ...
    link: [
    {rel: 'canonical', href: 'https://www.aaryatables.com/energy/candela-to-lumens'}
    ]
    }
    },
  data(){
  ...
  methods: {
    currentchange(){
      var cd  = parseFloat(this.number1);
var deg = parseFloat(this.number2);
deg *= Math.PI/180;
var xxx = cd*(2*Math.PI*(1-Math.cos(deg/2)));
this.kw = xxx;
  },
    reset(){
