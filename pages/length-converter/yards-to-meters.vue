...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Yards to Meter<hr>
      <h1 class="w3-text-teal"><b>Yards to Meters</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Yards:</div>
<div class="col">
      ...
      <div class="w3-margin w3-white">
        ...
        <h1 class=""><b>Other tools tools</b></h1>
          ...
          <ul class="w3-ul w3-hoverable w3-white">
            ...
            <li class="w3-padding-16">
              <span class="w3-large"><a class="removelink" href="/length-converter/yards-to-km"> Yards to Kilometers</a></span><br>
            </li>
            <li class="w3-padding-16">
...
export default {
  head() {
  return {
    title: 'Convert Yards to meters',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Yards to Meters.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/yards-to-meters'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
            ...
            var y = this.roundresult(x*0.9144);
            this.answer = y;
    },
    str2num(s)
    {
