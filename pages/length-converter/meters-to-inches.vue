...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Meter to Inches<hr>
      <h1 class="w3-text-teal"><b>Meters to Inches</b></h1>
      <Adsense
...
export default {
  ...
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Meters to Inches.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/meters-to-inches'}
  ]
  }
  },
  data(){
