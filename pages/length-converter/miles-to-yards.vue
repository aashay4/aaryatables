...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Miles to Yards<hr>
      <h1 class="w3-text-teal"><b>Miles to Yards</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Miles:</div>
<div class="col">
...
export default {
  head() {
  return {
    title: 'Convert Miles to Yard',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Miles to Yards.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/miles-to-yards'}
  ]
  }
  },
  data(){
