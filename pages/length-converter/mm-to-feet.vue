...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Millimeters to feet<hr>
      <h1 class="w3-text-teal"><b>mm to feet</b></h1>
      <Adsense
...
export default {
  head() {
  return {
    title: 'Convert mm to feet',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Millimeters to Feet.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/mm-to-feet'}
  ]
  }
  },
  data(){
