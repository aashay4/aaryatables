...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Inches to Meters<hr>
      <h1 class="w3-text-teal"><b>Inches to Meter</b></h1>
      <Adsense
...
export default {
  ...
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Inches to Meters.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/inches-to-meters'}
  ]
  }
  },
  data(){
  ...
  methods: {
    calculate(){
            ...
            var y = this.roundresult(x*0.0254);
            this.answer = y;
    },
    str2num(s)
    {
