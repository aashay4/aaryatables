...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Yards to Kilometers<hr>
      <h1 class="w3-text-teal"><b>Yards to km</b></h1>
      <Adsense
...
export default {
  head() {
  return {
    title: 'Convert Yards to km',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Yards to Kilometers.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/yards-to-km'}
  ]
  }
  },
  data(){
