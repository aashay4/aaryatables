...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; CM to Miles<hr>
      <h1 class="w3-text-teal"><b>Centimeters to miles</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Centimeter:</div>
<div class="col">
...
export default {
  head() {
  return {
    title: 'Convert Centimeters to Miles',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'CM to Miles.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/cm-to-miles'}
  ]
  }
  },
  data(){
