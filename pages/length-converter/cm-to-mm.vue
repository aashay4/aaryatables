...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; CM to MM<hr>
      <h1 class="w3-text-teal"><b>cm to mm</b></h1>
      <Adsense
...
export default {
  head() {
  return {
    title: 'Convert Centimeters to Millimeter',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'CM to Millimeter.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/cm-to-mm'}
  ]
  }
  },
  data(){
