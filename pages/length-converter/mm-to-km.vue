...
<div class="w3-col l8 s12">
  ...
  <div class="w3-margin w3-white">
    <div class="w3-container w3-padding">
          <a href="/">Home</a> &rsaquo; <a href="/length-converter">Length</a> &rsaquo; Millimeters to km<hr>
      <h1 class="w3-text-teal"><b>mm to km</b></h1>
      <Adsense
...
<div class="form-row">
<div class="col-auto">Enter Millimters:</div>
<div class="col">
...
export default {
  head() {
  return {
    title: 'Convert Millimeters to kilometers',
  // optional; sets final title as "Index Page - My Website", useful for multiple level meta
  // meta tags
  meta: [
    { hid: 'description', name: 'description', content: 'Millimeters to Kilometer.'}
  ],
  link: [
  {rel: 'canonical', href: 'https://www.aaryatables.com/weight-converter/mm-to-km'}
  ]
  }
  },
  data(){
